...
class ViewPlayer(Frame):
    def __init__(self, parent, playerHex, controller=None, *args, **kwargs):
        ...
        self.canvas.create_text(
            ...
            64.0,
            anchor="nw",
            text= "#" + str(api.Player1.globalRank),
            fill="#FFFFFF",
            font=("Inter", 24 * -1)
        )
        ...
        self.canvas.create_text(
            ...
            100.0,
            anchor="nw",
            text="#" + str(api.Player1.localRank),
            fill="#FFFFFF",
            font=("Inter", 24 * -1)
        )
        ...
        self.canvas.create_text(
            ...
            173.0,
            anchor="nw",
            text=str(api.Player1.rankedAcc)[0:5] + "%",
            fill="#FFFFFF",
            font=("Inter", 24 * -1)
        )
        ...
        self.image_flag = PhotoImage(
            file=relative_to_assets("flags/" + api.Player1.country +".png"))
        self.canvas.create_image(
            170.0,
            112.0,
            image=self.image_flag)

        self.image_icon = getIcon(api.Player1.icon)
